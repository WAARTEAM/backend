...
/* harmony import */ var _components_chatpage_chatpage_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/chatpage/chatpage.component */ "./src/app/components/chatpage/chatpage.component.ts");
...
/* harmony import */ var _guards_notauth_guard__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./guards/notauth.guard */ "./src/app/guards/notauth.guard.ts");
/* harmony import */ var _components_search_area_search_area_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/search-area/search-area.component */ "./src/app/components/search-area/search-area.component.ts");
...
const routes = [
    { path: "", component: _components_landing_landing_component__WEBPACK_IMPORTED_MODULE_3__["LandingComponent"], canActivate: [_guards_notauth_guard__WEBPACK_IMPORTED_MODULE_9__["NotAuthGuard"]] },
    { path: "login", component: _components_login_login_component__WEBPACK_IMPORTED_MODULE_4__["LoginComponent"], canActivate: [_guards_notauth_guard__WEBPACK_IMPORTED_MODULE_9__["NotAuthGuard"]] },
    ...
    { path: "info", component: _components_settings_settings_component__WEBPACK_IMPORTED_MODULE_11__["SettingsComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_8__["AuthGuard"]] },
    { path: "users/:username", component: _components_profile_profile_component__WEBPACK_IMPORTED_MODULE_6__["ProfileComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_8__["AuthGuard"]] },
    { path: "register", component: _signup_signup_component__WEBPACK_IMPORTED_MODULE_5__["SignupComponent"], canActivate: [_guards_notauth_guard__WEBPACK_IMPORTED_MODULE_9__["NotAuthGuard"]] },
    { path: "chatroom", component: _components_chatpage_chatpage_component__WEBPACK_IMPORTED_MODULE_7__["ChatpageComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_8__["AuthGuard"]] },
    { path: "search", component: _components_search_area_search_area_component__WEBPACK_IMPORTED_MODULE_10__["SearchAreaComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_8__["AuthGuard"]] }
];
...
/* harmony import */ var _components_chatpage_chatpage_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./components/chatpage/chatpage.component */ "./src/app/components/chatpage/chatpage.component.ts");
...
/* harmony import */ var _components_search_area_search_area_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./components/search-area/search-area.component */ "./src/app/components/search-area/search-area.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _components_chatpage_chatpage_component__WEBPACK_IMPORTED_MODULE_15__["ChatpageComponent"],
...
let ChatpageComponent = class ChatpageComponent {
    ...
    getChatroom() {
        ...
        this.http.get(`/groups/${this.currentRoom._id}`).subscribe(chatroom => {
            ...
            if (this.messages[0])
                this.socket.emit("joinRoom", this.currentRoom._id);
        });
    }
    ...
    getMessages() {
        if (this.messages && this.messages[0])
            this.socket.emit("leaveRoom", this.messages[0]._id);
        this.messages = undefined;
        if (this.currentReceiver) {
            this.http
                ...
                if (messages[0])
                    this.socket.emit("joinRoom", messages[0]._id);
...
], ChatpageComponent.prototype, "onResize", null);
ChatpageComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: "app-chatpage",
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./chatpage.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/chatpage/chatpage.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./chatpage.component.scss */ "./src/app/components/chatpage/chatpage.component.scss")).default]
    })
], ChatpageComponent);
...
let ProfileComponent = class ProfileComponent {
    constructor(http, activatedRoute, authService) {
        this.http = http;
        ...
        this.activatedRoute.params.subscribe(param => {
            ...
            if (this.profile)
                this.$user = this.http
                    ...
                    .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(one => one["user"]));
            else {
                this.$user = this.http
            ...
            this.$user.subscribe(user => {
                this.id = user._id;
                if (user.areFriends)
                    this.status = "Remove friend";
                else if (user.sentRequest)
                    this.status = "Remove friend request";
                else if (user.gotrequest)
                    this.status = "Accept friend request";
                else
    ...
    getAllFreinds() {
        ...
        this.http
            .get(`/users/${this.id}/friends`).subscribe((data) => {
    ...
    acceptFriendRequest(id) {
        this.http.get(`/users/${id}/acceptrequest`).subscribe((data) => {
            if (data["success"]) {
...
let SearchAreaComponent = class SearchAreaComponent {
...
SearchAreaComponent.ctorParameters = () => [
    { type: src_app_services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"] },
    { type: src_app_services_http_http_service__WEBPACK_IMPORTED_MODULE_3__["HttpService"] }
];
SearchAreaComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-search-area',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./search-area.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/search-area/search-area.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./search-area.component.scss */ "./src/app/components/search-area/search-area.component.scss")).default]
    })
], SearchAreaComponent);
...
let SettingsComponent = class SettingsComponent {
    constructor(http, authService, validateService, flashMessage, router) {
        this.http = http;
        this.authService = authService;
    ...
    ngOnInit() {
        this.$user = this.http
            .get(`/users/${this.authService.getUsername()}`)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(one => one["user"]));
    }
};
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _http_http_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./http/http.service */ "./src/app/services/http/http.service.ts");
...
let DataService = class DataService {
    ...
    calcTime(date, max) {
        if (!date)
            return "";
        var d = new Date(date), diff = ((Date.now() - d.getTime()) / 1000);
...
module.exports = __webpack_require__(/*! C:\Users\Abobker\Desktop\ng-nodes-web\src\main.ts */"./src/main.ts");
